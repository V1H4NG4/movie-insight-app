...
export default function LoadingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-950 via-red-700 to-red-950 flex items-center justify-center p-4 relative overflow-hidden">
      <style jsx>{`
        @keyframes fadeIn {
          from {
            opacity: 0;
