...
export default function LoadingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-yellow-950 to-black flex items-center justify-center p-4 relative overflow-hidden">
      <style jsx>{`
        @keyframes fadeIn {
          from {
            opacity: 0;
