...
CREATE TABLE wishlists (
  id BIGINT AUTO_INCREMENT PRIMARY KEY,
  geek_id BIGINT NOT NULL,
  movie_1 BIGINT DEFAULT NULL,
  movie_2 BIGINT DEFAULT NULL,
  movie_3 BIGINT DEFAULT NULL,
  movie_4 BIGINT DEFAULT NULL,
  movie_5 BIGINT DEFAULT NULL,
  movie_6 BIGINT DEFAULT NULL,
  movie_7 BIGINT DEFAULT NULL,
  movie_8 BIGINT DEFAULT NULL,
  movie_9 BIGINT DEFAULT NULL,
  movie_10 BIGINT DEFAULT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  
  CONSTRAINT fk_wishlists_geek FOREIGN KEY (geek_id)
    REFERENCES geek_user(id)
    ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;